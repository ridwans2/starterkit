...
return [
    /*
     | Kill-switch do kit: lido pelo ->authorize() do plugin no painel infra.
     | Some da navegação sem tocar em nenhuma outra configuração.
     */
    'enabled' => env('COMMAND_CENTER_ENABLED', true),
    ...
    'commands' => [
        ...
        'health-check' => [
            'run'     => 'health:check',
            'label'   => 'Executar health checks',
            'group'   => 'Diagnostics',
            'help'    => 'Runs the Spatie Health checks and stores the result (Health page).',
            'timeout' => 30,
        ],
        'backup-run' => [
            'run'     => 'backup:run',
            ...
            'group'   => 'Maintenance',
            'help'    => 'Backs up database and files per config/backup.php.',
            'timeout' => 1800,
            'queue'   => true,
            'confirm' => 'Executar o backup completo agora?',
        ],
